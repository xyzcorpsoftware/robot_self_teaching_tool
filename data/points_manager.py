...
class RobotPointsManager:
    ...
    def add_relative_points(self):
        ...
        relative_defs = [
            ...
            ("CUP3_FAST_HOLD_L", "CUP3_FAST_APP_L", [-150, 0, 0, 0, 0, 0]),
            ("CUP2_FAST_HOLD_L", "CUP2_FAST_APP_L", [-150, 0, 0, 0, 0, 0]),
            ("CUP1_FAST_HOLD_L", "CUP1_FAST_APP_L", [-150, 0, 0, 0, 0, 0]),
        ]
